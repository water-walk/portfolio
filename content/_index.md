...
<style>
  ...
  /* 画像のような重なり文字を作るための専用デザイン */
  .section-title-container {
    position: relative;
    margin-bottom: 40px;
    height: 90px; /* 文字が重なる高さを確保 */
  }
  ...
  .bg-en-title {
    ...
    top: 0;
    left: 0;
    font-size: 4.5rem; /* 大きな英字 */
    font-weight: 800;
    color: rgba(173, 216, 230, 0.45); /* 水色（透過） */
    line-height: 1;
    letter-spacing: 4px;
    user-select: none;
  }
  ...
  .fg-ja-title {
    position: absolute;
    bottom: 5px;
    left: 10px; /* 少し左下にずらして重ねる */
    font-size: 1.6rem; /* 日本語タイトル */
    font-weight: 700;
    color: #111;
    line-height: 1;
    z-index: 2;
